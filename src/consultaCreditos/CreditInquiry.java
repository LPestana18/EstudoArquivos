...
public class CreditInquiry {
    ...
    // obtem a solicitação do usuário
    private static MenuOption getRequest() {

        int request = 4;

        // exibe opção de solicitação
    ...
    // lê registros de arquivo e exibe somente os registros do tipo apropiado
